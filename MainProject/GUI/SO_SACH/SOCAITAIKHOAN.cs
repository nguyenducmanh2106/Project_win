...
namespace KETOANDOANHTHU
{
    public partial class SoCaiTaiKhoan : Form
    {
        ...
        private void DrawingTableLayout(CoreModel obj)
        {
            ...
            var result = bll.GetDataTableSoCaiTaiKhoan(obj);
            details = CustomConvert.ToDataTable<SoCaiTaiKhoanModel>(result);
            foreach (var item in result)
            {
                ...
                dt.Rows.Add(NgayThangGhiSo, item.SoHieu, NgayThangChungTu, item.DIENGIAI, item.TRANGSO, item.STT_DONG, item.TKDOIUNG, item.SONO?.ToString("n2"), item.CO?.ToString("n2"));
            }
            ...
            foreach (var dic in headers)
            {
                ...
                if (dic.Key == "col2" || dic.Key == "col4" || dic.Key == "col6")
                {
        ...
        private void ToExcel(DataTable details, string fileOutputName)
        {
            ...
            try
            {
                ...
                string fileTemplateName = "SoCaiTaiKhoan.xlsx";
        ...
        {
            saveFileDialog1.FileName = "SoCaiTaiKhoan.xlsx";
