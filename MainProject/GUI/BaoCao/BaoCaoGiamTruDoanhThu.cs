...
{
    public partial class BaoCaoGiamTruDoanhThu : Form
    {
        ...
        private void ToExcel(DataGridView dataGridView1, string fileOutputName)
        {
            ...
            try
            {
                ...
                var data = Newtonsoft.Json.JsonConvert.DeserializeObject<List<BaoCaoGiamTruDoanhThuModel>>(data1);
                DataTable detail = CustomConvert.ToDataTable<BaoCaoGiamTruDoanhThuModel>(data);
                detail.TableName = "details";
                DataSet ds = new DataSet();
                ds.Tables.Add(detail);
                string fileTemplateName = "ReportRevenueDecreasing.xlsx";
        ...
        {
            saveFileDialog1.FileName = "ReportRevenueDecreasing.xlsx";
