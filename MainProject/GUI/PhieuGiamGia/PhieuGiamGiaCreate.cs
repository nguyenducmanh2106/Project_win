...
namespace QLBANXE
{
    public partial class PhieuGiamGiaCreate : Form
    {
        ...
        private void SaveButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (result)
                    {
                        new ShowMessageBox().Success(String.Format(MessageConstants.InsertSuccessMessage, "phiếu giảm giá"));
                        this.Dispose(true);
                    }
                    else
                    {
                        new ShowMessageBox().Error(String.Format(MessageConstants.InsertErrorMessage, "phiếu giảm giá"));
                    }
                }
            }
